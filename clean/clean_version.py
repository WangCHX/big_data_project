...
i = 0
def get_check_in_info(user_id, id):
	global i
	dt = date.today()
...
#	print user_id, lat, lng, date_info, categories_name
	...
	with open("test.txt", "a") as myfile:
		i += 1
		print i
		myfile.write(user_id + '\t' + categories_name + '\n')
		
source_file = 'nyc_10_09_all.tsv'
...
#		line = ''.join(content1)
#		print line
		first_tab = content1.find('\t')
		user_id = content1[:first_tab]
		print user_id
		line = content1
		...
		if index_first != -1:
			...
			try:
				...
				get_check_in_info(user_id, venue_id)
